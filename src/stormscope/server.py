...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "level pressure. The pressure_source field is 'tempest' when the Tempest "
        "station's own SLP is used, 'tempest_slp' when station pressure was "
        "reduced to SLP locally as a fallback, or 'sea_level' when NWS "
        "altimeter-corrected pressure was used. Forecasts "
